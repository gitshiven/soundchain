    ...
    <>
      ...
      <main style={{
        ...
        <nav style={{
          ...
          <div style={{ fontSize: '13px', color: '#666', letterSpacing: '3px', textTransform: 'uppercase' }}>SOLANA DEVNET</div>
                ...
                {publicKey ? (
                  <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap' }}>
                    <Link href="/post-challenge" style={{
                      background: '#f5f5f5', color: '#080808', border: 'none', padding: '16px 32px',
                      fontSize: '14px', letterSpacing: '3px', fontFamily: '"Courier New", monospace',
                      fontWeight: '700', cursor: 'pointer', textTransform: 'uppercase',
                      textDecoration: 'none', display: 'inline-block',
                    }}>POST CHALLENGE →</Link>
                    <Link href="/browse" style={{
                      background: 'transparent', color: '#f5f5f5',
                      border: '1px solid rgba(245,245,245,0.4)', padding: '16px 32px',
                      fontSize: '14px', letterSpacing: '3px', fontFamily: '"Courier New", monospace',
                  ...
                  <WalletMultiButton style={{
                    ...
                    letterSpacing: '3px', padding: '16px 32px', textTransform: 'uppercase', fontWeight: '700',
                  }} />
                )}
              </div>
            </TextReveal>
        ...
        <div style={{ borderTop: '1px solid #222', borderBottom: '1px solid #222', padding: '14px 0', overflow: 'hidden', whiteSpace: 'nowrap', background: '#0d0d0d' }}>
          <span style={{ display: 'inline-block', animation: 'marquee 22s linear infinite', fontSize: '13px', letterSpacing: '5px', color: '#555', textTransform: 'uppercase' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', flexWrap: 'wrap', borderBottom: '1px solid #1a1a1a' }}>
          {[
            ...
            <div key={i} style={{ padding: '48px 32px', borderRight: i < 2 ? '1px solid #1a1a1a' : 'none' }}>
              <div style={{ fontSize: '13px', color: '#c8a96e', letterSpacing: '4px', marginBottom: '24px' }}>
                {item.num} ──────
              </div>
              <div style={{ fontSize: 'clamp(40px, 5vw, 72px)', fontWeight: '900', fontFamily: 'Arial Black, sans-serif', lineHeight: 1, marginBottom: '4px' }}>
                {item.title}
              </div>
              <div style={{ fontSize: '13px', color: '#444', letterSpacing: '4px', marginBottom: '24px' }}>{item.sub}</div>
              <div style={{ fontSize: '15px', color: '#666', lineHeight: 1.8 }}>{item.desc}</div>
            </div>
          ))}
        </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', flexWrap: 'wrap', borderBottom: '1px solid #1a1a1a', background: '#0d0d0d' }}>
          {[
            ...
            <div key={i} style={{ padding: '40px 32px', borderRight: i < 2 ? '1px solid #1a1a1a' : 'none', textAlign: 'center' }}>
              ...
              <div style={{ fontSize: '13px', color: '#555', letterSpacing: '4px' }}>{stat.label}</div>
            </div>
          ))}
        </div>
        ...
        <div style={{ padding: '80px 32px', display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', gap: '32px' }}>
          <TextReveal delay={0}>
            <div style={{ fontSize: '13px', color: '#c8a96e', letterSpacing: '6px', textTransform: 'uppercase' }}>
        ...
        <div style={{ borderTop: '1px solid #1a1a1a', padding: '20px 32px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', fontSize: '13px', color: '#333', letterSpacing: '2px', flexWrap: 'wrap', gap: '8px' }}>
          <img src="/soundchain-icon.svg" alt="SoundChain" style={{ height: '28px', width: 'auto' }} />
